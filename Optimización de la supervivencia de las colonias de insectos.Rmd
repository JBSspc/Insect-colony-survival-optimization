...
<h2 style = "text-align-left">**Metodología**</h2></br>
...
<p>a) Muestre cómo es la curva de $Q(T = 205)$ frente a $t_{s}$. Es decir, pruebe una serie de tiempos de conmutación, $t_{s}$ en el intervalo de tiempo $[0, 205]$ (en un rango amplio y en un rango estrecho sobre su valor óptimo, recoja los puntos de datos resultantes $(t_{s}, Q(205))$ en un conjunto, llamado datos, y grafique estos puntos para ver cuál podría ser un tiempo de conmutación óptimo.
b) Utilizando el tiempo de conmutación óptimo de la colonia que has descubierto en $(3)$, muestra cómo se compara con todos los resultados de la sección Modelo - ¡prueba! anterior y con tu propia estrategia en $(2)$.</p></br></div>

<div align="justify"><p>Explore el efecto en nuestra estrategia de optimización de $(3)$ si cambiamos nuestro valor de $c$ - recuerde cuál es el significado de c - vea arriba. Por ejemplo, supongamos que cambiamos nuestro problema de $c = 1$ a, digamos, $c = 2$, o $c= \frac{1}{2}$ (asegúrese de explicar lo que cada uno de estos significa en términos de la colonia y el modelo) entonces, ¿qué efecto tienen estos cambios en nuestro tiempo de conmutación óptima?</p></br>
<p>Explore el efecto en nuestra estrategia de optimización de $(3)$ si cambiamos nuestra función $R(t)$ para modelar más estrechamente la disponibilidad de recursos tal y como se modela en la función de retorno estacional (en este caso 205 días desde principios de primavera hasta finales de otoño). Proponga una función para $R(t)$ que sea diferente de $R(t) = 50$, que cree que podría ser un modelo de recursos estacionales. A continuación, compare los resultados de su modelo con los de $(3)$. Explique las diferencias o similitudes.</p></br>
<p>Se sabe que algunas especies (por ejemplo, las abejas) forman enjambres o se levantan y abandonan la colmena, ya que los reproductores inician nuevas colonias en mitad de la temporada. Modele este comportamiento con los parámetros, $b= 0,0013$, $c = 1$, $\mu = 0,022$, $v = 0,005$, $T = 205- días$, y $R(t) = 50$. A continuación, compare esto con sus resultados (es decir, el número de reproductores disponibles al final de la temporada) en su tiempo de cambio óptimo descubierto en la sección Solución bang-bang anterior. Haz las suposiciones adicionales que necesites.</p></div>

<h2 style = "text-align-left">**Resultados**</h2></br>
...
![$u_{1}$](C:/Users/sofia/OneDrive/Documentos/EDO/u1.png)

</center>

<div align = "justify"> En este caso, podemos ver que...COMPLETAR </div>

<center>

![$u_{2}$](C:/Users/sofia/OneDrive/Documentos/EDO/2.png)
...
![$u_{3}$](C:/Users/sofia/OneDrive/Documentos/EDO/u3.png)
...
![Modelo OSCI con $u_{1}$](C:/Users/sofia/OneDrive/Documentos/EDO/w_Q_u1.png)
...
![Modelo OSCI con $u_{2}$](C:/Users/sofia/OneDrive/Documentos/EDO/W_Q_u2.png)
...
![Modelo OSCI con $u_{3}$](C:/Users/sofia/OneDrive/Documentos/EDO/W_Q_u3.png)
